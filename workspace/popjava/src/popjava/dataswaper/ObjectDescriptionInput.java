...
//		ODElement bandwidth = ODElement.deserialize(buffer);
		float powerReq = buffer.getFloat();
		float powerMin = buffer.getFloat();
		float memoryReq = buffer.getFloat();
		float memoryMin = buffer.getFloat();
		float bandwidthReq = buffer.getFloat();
		float bandwidthMin = buffer.getFloat();
		...
		this.setPower(powerReq, powerMin);
		this.setMemory(memoryReq, memoryMin);
		this.setBandwidth(bandwidthReq, bandwidthMin);
